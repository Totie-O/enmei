...
# 读取店铺在架
#############################################################
df_online = pd.read_excel('D:/桌面/店铺在架/10.14店铺在架.xlsx', usecols=["店铺名称","站点名称","平台店铺款式编码","平台店铺商品编码","线上款式编码","线上商品编码","原始商品编码","线上商品名称","线上颜色规格","店铺库存","店铺售价","是否上架","系统款式编码","系统商品编码","系统商品名称","系统颜色规格"], sheet_name='Sheet1')
